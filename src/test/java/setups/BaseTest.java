...
//    }
    ...
    public void setUp() throws Exception {
        ...
        JSONObject config = (JSONObject) parser.parse(new FileReader("src/test/resources/first.conf.json"));
        ...
        ThreadLocalDriver.setTLDriver(new AndroidDriver<MobileElement>(new URL("http://"+username+":"+accessKey+"@"+config.get("server")+"/wd/hub"), capabilities));
    }
